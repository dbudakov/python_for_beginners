...
\ \ числовой ряд
**enumerate**
\ \ генератор, возвращает пары значений где первое это индекс, а второе это значение из переданного внутрь объекта
**end**
**join**
**continue**
\ \ обрывает ход цикла
**yield**
\ \ генератор возвращает одно значение
**function**(seq) - последовательность
**function**(start) - начальное значение
**Рекурсия** -
**lambda**
